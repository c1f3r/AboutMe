...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AboutUser.avatar'
        db.alter_column(u'hello_aboutuser', 'avatar', self.gf('stdimage.models.StdImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'AboutUser.avatar'
        db.alter_column(u'hello_aboutuser', 'avatar', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    models = {
        ...
        u'hello.aboutuser': {
            ...
            'avatar': ('stdimage.models.StdImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'username': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '20'})
        },
        u'hello.event': {
