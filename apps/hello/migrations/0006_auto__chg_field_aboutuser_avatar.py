...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'hello_aboutuser', 'avatar', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
    ...
    models = {
        ...
        u'hello.aboutuser': {
            ...
            'avatar': ('django.db.models.fields.files.ImageField', [], {'default': "'img/no-avatar.jpg'", 'max_length': '100'}),
