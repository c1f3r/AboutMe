...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HttpRequestLog.priority'
        db.add_column(u'hello_httprequestlog', 'priority',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HttpRequestLog.priority'
        db.delete_column(u'hello_httprequestlog', 'priority')
